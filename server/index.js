...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var server, seedDatabase, error_1, port;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.trys.push([2, 5, , 6]);
                return [4 /*yield*/, Promise.resolve().then(function () { return require("./seedData"); })];
            case 3:
                seedDatabase = (_a.sent()).seedDatabase;
            ...
            case 6:
                ...
                if (!(app.get("env") === "development")) return [3 /*break*/, 8];
